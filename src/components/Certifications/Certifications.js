...
const CERTIFICATIONS = [
  {
    img: process.env.PUBLIC_URL + "/images/Certificados/unesc.png",
    title: "Faculdade de Sistema da Informação (5º semestre)",
    link: "https://unesc.net/home",
  },
  {
    img: process.env.PUBLIC_URL + "/images/Certificados/PDVJavaSQL.jpg",
  ...
  {
    img: process.env.PUBLIC_URL + "/images/Certificados/JavaBasico.jpg",
  ...
  {
    img: process.env.PUBLIC_URL + "/images/Certificados/JsAlura.png",
    title: "Javascript e HTML: Desenvolva um jogo e pratique lógica de programação",
    link: "https://www.alura.com.br/",
  },
  {
    img: process.env.PUBLIC_URL + "/images/Certificados/CBasicoAlura.png",
